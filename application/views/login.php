  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('auth/login'); ?>" method="post" id="frm-login">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" name="txt-username" class="error" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="txt-password" class="error" required>
