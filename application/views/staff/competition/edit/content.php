            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" class ="datepicker" value='<?php echo $obj->start?>' data-date-format="yyyy-mm-dd" class="form-control error" name="start" id="start" placeholder="วว/ดด/ปปปป" required>
                </div>
